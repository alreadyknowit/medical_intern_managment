...
class _AttendingPhysicianState extends State<AttendingPhysician> {
  ...
  @override
  Widget build(BuildContext context) => Builder(builder: (BuildContext context) {
      return Scaffold(
        appBar: buildAppBar(),
        body: SafeArea(
          child: Padding(
            ...
            child: Column(
              children: [
                ...
                Expanded(child: Text("Onaylamak için sağa doğru, reddetmek için sola doğru kaydırın.", textAlign: TextAlign.center, style: TEXT_STYLE.copyWith(fontSize:14),)),
              ],
            ),
          ),
        ),
